            ...
            <div class="topbar-left">
                <a href="<?php echo base_url('user')?>" class="logo">
                    <span class="logo-light">
                            <i class="fas fa-user-graduate mr-2"></i> SIP | USER
                        </span>
                    <span class="logo-sm">
            ...
            <div class="slimscroll-menu" id="remove-scroll">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url('user/test')?>" class="waves-effect">
                                <i class="icon-todolist"></i><span> Test </span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('user/hasil')?>" class="waves-effect">
                                <i class="icon-todolist"></i><span> Status Kelulusan </span>
                            </a>
                        </li>
                    </ul>
