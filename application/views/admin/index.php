                ...
                <div class="container-fluid">
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="card">
                                <div class="card-heading p-4">
                                    ...
                                    <h3 class="mt-4">200</h3>
                                    <div class="progress mt-4" style="height: 4px;">
                                        <div class="progress-bar bg-primary" role="progressbar" style="width: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <p class="text-muted mt-2 mb-0">Pendaftar<span class="float-right">75%</span></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="card">
                                <div class="card-heading p-4">
                                    ...
                                    <div>
                                        <h5 class="font-16">Pending</h5>
                                    </div>
                                    <h3 class="mt-4">25</h3>
                                    <div class="progress mt-4" style="height: 4px;">
                                        <div class="progress-bar bg-warning" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <p class="text-muted mt-2 mb-0">Persyaratan belum selesai<span class="float-right">25%</span></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="card">
                                <div class="card-heading p-4">
                                    ...
                                    <div>
                                        <h5 class="font-16">Cancel</h5>
                                    </div>
                                    <h3 class="mt-4">0</h3>
                                    <div class="progress mt-4" style="height: 4px;">
                                        <div class="progress-bar bg-danger" role="progressbar" style="width: 0%" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <p class="text-muted mt-2 mb-0">Gagal Pendaftaran<span class="float-right">0%</span></p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4">
                            <div class="card m-b-30">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title mb-4">JURUSAN</h4>
